						...
						<div class="table-responsive">
							...
							<?php for($i=0;$i<sizeof($ndsales);$i++) { ?>
								<tr class="warning" id="tr-<?php echo $ndsales[$i]['id']; ?>">
									...
									<td><?php echo ($ndsales[$i]['total']+$ndsales[$i]['shipping']).' '.$system['currency'.$lang_file]; ?></td>
									<td><?php echo $ndsales[$i]['name']; ?></td>
									<td><?php echo $ndsales[$i]['address']; ?></td>
									<td><?php echo $ndsales[$i]['phone']; ?></td>
									<td><?php echo $ndsales[$i]['city']; ?></td>
						...
						<div class="table-responsive">
							...
							<?php for($j=0;$j<sizeof($dsales);$j++) { ?>
								<tr class="warning" id="tr-<?php echo $dsales[$j]['id']; ?>">
									...
									<td><?php echo ($dsales[$j]['total']+$dsales[$j]['shipping']).' '.$system['currency'.$lang_file]; ?></td>
									<td><?php echo $dsales[$j]['name']; ?></td>
									<td><?php echo $dsales[$j]['address']; ?></td>
									<td><?php echo $dsales[$j]['phone']; ?></td>
									<td><?php echo $dsales[$j]['city']; ?></td>
									<td><?php echo date('Y-m-d , h:i:sa', $dsales[$j]['dtime']); ?></td>
									<td>
