			...
			<div class="col-md-12">
				...
				<table class="table table-bordered">
					...
					<tr>
						...
						<td class="warning"><?php if(!empty($product['categories'])) { $productcats['categories'] = explode("|", $product['categories']); for($j=0;$j<count($productcats['categories']);$j++) { echo ($j+1).' - '.getCategoryNameFromChildto($productcats['categories'][$j],$lang_file).'<br>'; } } else language('nocategories'); ?></td>
					</tr>
					<?php } ?>
					<tr>
					...
					<tr>
						...
						<td class="warning"><input type="text" name="oldprice" value="<?php if(isset($product['oldprice'])) echo $product['oldprice']; ?>" pattern="[-+]?([0-9]*\.[0-9]+|[0-9]+)" title="<?php language('oldpricematch'); ?>" maxlength="50" class="form-control" /><?php echo $system['currency'.$lang_file]; ?></td>
					</tr>
					<tr>
						<td class="info"><?php language('price'); ?></td>
						<td class="warning"><input type="text" name="price" value="<?php if(isset($product['price'])) echo $product['price']; ?>" pattern="[-+]?([0-9]*\.[0-9]+|[0-9]+)" title="<?php language('pricematch'); ?>" maxlength="50" class="form-control" required="required" /><?php echo $system['currency'.$lang_file]; ?></td>
					</tr>
					<tr>
			...
			<div class="col-md-12">
				...
				<?php for($i=0;$i<sizeof($products);$i++) { ?>
					<tr id="tr-<?php echo $products[$i]['id']; ?>">
						...
						<td><?php echo $products[$i]['oldprice'].' '.$system['currency'.$lang_file]; ?></td>
						<td><?php echo $products[$i]['price'].' '.$system['currency'.$lang_file]; ?></td>
								...
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<div><?php if(!empty($products[$i]['categories'])) { $productscats[$i]['categories'] = explode("|", $products[$i]['categories']); for($j=0;$j<count($productscats[$i]['categories']);$j++) { echo ($j+1).' - '.getCategoryNameFromChildto($productscats[$i]['categories'][$j],$lang_file).'<br>'; } } else language('nocategories'); ?></div><br><br><br>
