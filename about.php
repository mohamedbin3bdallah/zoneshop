...
<body>
	...
	<!--banner-->
		<div class="banner1" dir="rtl">
			<div class="container">
				<h3><a href="index.php"><?php language('home'); ?></a> / <span><?php language('about'); ?></span></h3>
			</div>
		</div>
	<!--banner-->
			...
			<div class="login" <?php if(!isset($_COOKIE['lang']) || (isset($_COOKIE['lang']) && $_COOKIE['lang'] == 'ar')) { ?>dir="rtl"<?php } ?>>
				<div class="main-agileits">
					<div class="form-w3agile">
						<h3><?php language('vision'); ?></h3>
						<?php echo '<div style="text-align: justify; font-size: 200%; margin-top: 25px; margin-bottom: 25px;">'; echo $about['vision']; echo '</div>'; ?>
					</div>
				</div>
				<div class="main-agileits">
					<div class="form-w3agile">
						<h3><?php language('mission'); ?></h3>
						<?php echo '<div style="text-align: justify; font-size: 200%; margin-top: 25px; margin-bottom: 25px;">'; echo $about['mission']; echo '</div>'; ?>
					</div>
				</div>
			</div>
				<!--login-->
